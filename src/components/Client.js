    ...
    <form>
      ...
      <div class="grid grid-cols-1 md:grid-cols- gap-x- gap-y-">
        ...
        <div class="flex  ">
          ...
          <input type="text" id="name" name="name" placeholder="NIDA AHMAD BUKHARI" class="w-full p-2 border border-gray-300  rounded-tr-lg rounded-br-lg"/>
        </div>
        {/* <!-- CNIC --> */}
        <div class="flex ">
          ...
          <input type="text" id="cnic" name="cnic" placeholder="36302-7681633-2" class="w-full p-2 border border-gray-300  " />
        </div>
        {/* <!-- Address --> */}
        <div class="flex ">
          ...
          <input type="text" id="address" name="address" placeholder="CHONGI NO 4 NISHAT ROAD MTN" class="w-full p-2 border border-gray-300  " />
        </div>
        {/* <!-- Mailing Address --> */}
        <div class="flex ">
          ...
          <input type="text" id="mailing_address" name="mailing_address" placeholder="CHONGI NO 4 NISHAT ROAD MTN" class="w-full p-2 border border-gray-300  " />
        </div>
        {/* <!-- Phone and Email --> */}
        {/* <!-- <div class="gap-y-2"> --> */}
            <div class=" gap-x-6 grid  grid-cols-1 md:grid-cols-2 ">
                <div class="flex">
                    <label for="phone" class="w-1/3  text-xs font-medium text-white bg-gray-700 p-2 placeholder border-b-2 border-white">CELL PHONE # & EMAIL</label>
                    <input type="text" id="phone" name="phone" placeholder="CELL PHONE # & EMAIL" class="w-full md:w-4/5 p-2 border border-gray-300  " />
                </div>
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="CLIENT EMAIL" class="w-full md:w-2/3 p-2 border border-gray-300  " />
                </div>
            </div>
            {/* <!-- DISCO --> */}
            <div class=" gap-x-6 grid grid-cols-1 md:grid-cols-2 ">
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="Multan Electric Power Company" class="w-full md:w-4/5 p-2 border border-gray-300  " />
                </div>
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="GULGASHT" class="w-full md:w-2/3 p-2 border border-gray-300  " />
                </div>
            </div>
            {/* <!-- Reference Number --> */}
            <div class=" gap-x-6 grid grid-cols-1 md:grid-cols-2 ">
                <div class="flex">
                    <label for="phone" class="w-1/3 text-xs font-medium text-white bg-gray-700 p-2 placeholder border-b-2 border-white">REFERENCE NUMBER</label>
                    <input type="text" id="phone" name="phone" placeholder="10 15171 6534707 U" class="w-full md:w-4/5 p-2 border border-gray-300  " />
                </div>
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="001819 NAWAB PUR ROAD" class="w-full md:w-2/3 p-2 border border-gray-300  " />
                </div>
            </div>
            {/* <!-- Customer ID --> */}
            <div class=" gap-x-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="S-P 1326483" class="w-full md:w-5/6 p-2 border border-gray-300  " />
                </div>
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="A-1b(03)T" class="w-full md:w-2/3 p-2 border border-gray-300  " />
                </div>
                <div class="flex">
                    <label for="phone" class="w-1/3 text-xs font-medium text-white md:text-center  bg-gray-700 p-2  border-b-2 border-t-2 border-white">FEEDER NAME</label>
                    <input type="text" id="phone" name="phone" placeholder="001819 NAWAB PUR ROAD" class="w-full md:w-2/3 p-2 border border-gray-300  " />
                </div>
            </div>
            {/* <!-- Meter Number --> */}
            ...
            <div class=" gap-x-6 grid grid-cols-1 md:grid-cols-2 ">
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="6" class="w-full md:w-4/5 p-2 border border-gray-300  " />
                </div>
                <div class="flex">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="8.190" class="w-full md:w-2/3 p-2 border border-gray-300  " />
                </div>
            </div>
